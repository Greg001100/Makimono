...
const Shortcuts = (props) => {
    ...
    useEffect(() => {
        ...
        awaitList();
        console.log(notebookArray, noteArray)
      }, [props.updateCount]);
    ...
    //                     })}
    //                 </div>
    //                 <div className="sp-text" id='note-list'>
    //                     {noteArray.map((note) => {
    //                         return (
    //                             <p key={note.id}>
    //                                 <Link className="sp-text" to={`/dashboard/${note.notebook}/${note.id}`}>{note.title ? note.title : "Untitled"}</Link>
    //                             </p>
    //                         )
    //                     })}
    //                 </div>
